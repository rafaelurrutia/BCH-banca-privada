<?php include "header.php" ?>
    <div id="content" class="wrapper">
        ...
        <div id="tab-container" class="tab-container">
            <ul class='etabs'>
                <li class='tab col-md-2'><a href="#tab1">OFICINAS</a></li>
                <li class='tab col-md-3'><a href="#tab2">EJECUTIVO Y ASISTENTE PERSONALIZADO</a></li>
                <li class='tab col-md-2'><a href="#tab3">SITIO WEB</a></li>
                <li class='tab col-md-3'><a href="#tab4">APLICACIONES MÓVILES</a></li>
                <li class='tab col-md-2'><a href="#tab5">FONOBANK</a></li>
            </ul>
            ...
            <div id="tab1" class="tab-content">
                <div class="layout-2 layout">
                    ...
                    <div class="inner table-box">
                        ...
                        <p><strong>Estas son nuestras oficinas con sus direcciones y números de contacto.</strong></p>
                        
                        <table>
                           <thead>
                               <tr>
                                   <th width="37%">NOMBRE OFICINA</th>
                                   <th width="38%">DIRECCIÓN</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Huérfanos Banca Privada</td>
                                    <td>Huérfanos 980, Piso 4</td>
                                    <td>+56 2 26531981</td>
                                </tr>
                                <tr>
                                    <td>Paseo Huérfanos Bca. Privada</td>
                                    <td>Huérfanos 980, Piso 2 y 4</td>
                                    <td>+56 2 26530650</td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="text-center subtitle">
                                ...
                                <tr>
                                    <td>Torre Las Condes Bca. Privada</td>
                                    <td>Av. Apoquindo 3721 ,Piso 2</td>
                                    <td>+56 2 24689576</td>
                                </tr>
                                <tr>
                                    <td>Apoquindo Banca Privada</td>
                                    <td>Av. Apoquindo 5555 ,Piso 2</td>
                                    <td>+56 2 24681452</td>
                                </tr>
                                <tr>
                                    <td>Pacífico Banca Privada</td>
                                    <td>Av. Andres Bello 2687 ,Piso 6</td>
                                    <td>+56 2 23388355</td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="text-center subtitle">
                                ...
                                <tr>
                                    <td>Nueva Vitacura Bca. Privada</td>
                                    <td>Av. Vitacura 3568</td>
                                    <td>+56 2 24687451</td>
                                </tr>
                            </tbody>
